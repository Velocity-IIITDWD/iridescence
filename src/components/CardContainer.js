      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="row">
            ...
            <MainCard name="Chinmay Shewale" role="Editing Head" email="21bcs108@iiitdwd.ac.in" image={Chinmay_Shewale} />
            <MainCard name="Mandar Dighe" role="Member" email="21bcs033@iiitdwd.ac.in" image={Mandar}/>
            <MainCard name="Ashitosh Sable" role="Member" email="21bcs096@iiitdwd.ac.in" image={Ashitosh}/>
          ...
          <MainCard name="Lohith B" role="Member" email="22bcs061@iiitdwd.ac.in" image={Lohith}/>
            <MainCard name="Jatin Kushwaha" role="Member" email="22bds030@iiitdwd.ac.in" image={Jatin} />
            <MainCard name="Harikiran" role="Member" email="22bcs060@iiitdwd.ac.in" image={Harikiran}/>
          ...
          <div className="row">
            ...
            <MainCard name="Aryan TN" role="Member" email="21bds006@iiitdwd.ac.in" image={Aryan_TN}/>
          ...
          <MainCard name="Priyansh" role="Member" email="22bcs092@iiitdwd.ac.in" image={Priyansh}/>
            ...
            <MainCard name="Vansh Tolani" role="Member" email="22bds061@iiitdwd.ac.in" image={vansh} />
          ...
          <div className="row">
            ...
            <MainCard name="Shreyansh Tiwari" role="Member" email="21bcs114@iiitdwd.ac.in" image={Shreyansh}/>
          ...
          <div className="row">
            ...
            <MainCard name="Vinay Jain" role="Member" email="22bcs137@iiitdwd.ac.in" image={Vinay_Jain}/>
          ...
          <MainCard name="T Sameera" role="Member" email="22bec047@iiitdwd.ac.in"/>
            <MainCard name="Aryan Jaiswal" role="Member" email="@iiitdwd.ac.in" image={Aryan_jaiswal}/>
